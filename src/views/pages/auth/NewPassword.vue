...
<template>
    <div :class="'login-body flex min-h-screen  ' + (isDarkTheme ? 'layout-dark' : 'layout-light')">
        <div class="login-image w-6/12 h-screen hidden md:block" style="max-width: 490px">
            <img :src="'/demo/images/pages/newpassword-' + (isDarkTheme ? 'ondark' : 'onlight') + '.png'" alt="atlantis"
            ...
            <Fluid
                ...
                <div class="flex flex-col">
                    ...
                    <div class="form-container text-left" style="max-width: 320px; min-width: 270px">
                        ...
                        <span class="block text-surface-600 dark:text-surface-200 font-medium mb-6 mt-4">Enter your new
                            password</span>
                        <IconField>
                            <InputIcon class="pi pi-key" />
                            <InputText type="password" autocomplete="off" placeholder="Password" class="block mb-4"
