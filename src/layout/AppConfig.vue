...
const primaryColors = ref([
    ...
    { name: 'sky', palette: { 50: '#f0f9ff', 100: '#e0f2fe', 200: '#bae6fd', 300: '#7dd3fc', 400: '#33c3f0', 500: '#0ea5e9', 600: '#0284c7', 700: '#0369a1', 800: '#075985', 900: '#0c4a6e', 950: '#082f49' } },
...
<template>
    <Button class="layout-config-button" @click="onConfigSidebarToggle" style="cursor: pointer">
        <i class="pi pi-cog"></i>
    </Button>

    <Drawer v-model:visible="layoutState.configSidebarVisible" position="right" header="Settings"
        class="layout-config-sidebar w-80" :pt="{
        ...
        <div class="flex flex-col gap-4">
            ...
            <div>
                <div class="flex flex-col gap-2">
                    ...
                    <SelectButton v-model="darkTheme" @change="toggleDarkMode" :options="themeOptions"
