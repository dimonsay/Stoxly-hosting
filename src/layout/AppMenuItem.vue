...
const { layoutConfig, layoutState, setActiveMenuItem, onMenuToggle, setMenuStates, setStaticMenuMobile, isHorizontal, isSlim, isSlimPlus, isDesktop, isOverlay, isStatic, isDrawer, isReveal } = useLayout();
